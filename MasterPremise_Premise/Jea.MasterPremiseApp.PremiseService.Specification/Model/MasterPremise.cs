...
{
    public partial class MasterPremise
    {
        public MasterPremise()
        {
            MasterServicePoints = new HashSet<MasterServicePoint>();
        }
        ...
        public virtual ICollection<MasterServicePoint> MasterServicePoints { get; set; }
    }
}
