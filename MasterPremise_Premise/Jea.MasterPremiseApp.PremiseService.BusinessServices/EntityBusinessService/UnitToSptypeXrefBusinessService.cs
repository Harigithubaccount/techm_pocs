...
{
    public class UnitToSptypeXrefBusinessService : BusinessServiceBaseReadonlyDBEntity<UnitToSptypeXref, int>, IUnitToSptypeXrefBusinessService
    {
        public UnitToSptypeXrefBusinessService(IUnitToSptypeXrefRepository repository) : base(repository)
        { }
    }
}
